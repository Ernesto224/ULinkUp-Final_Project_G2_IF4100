...
CREATE OR ALTER PROCEDURE Career.SP_Delete_Career_Subject
...
BEGIN
    BEGIN TRY
        IF EXISTS (SELECT TOP 1 1 FROM Career.TB_Career_Subject WHERE Career_ID = @Param_Career_ID AND Erased = 0)
